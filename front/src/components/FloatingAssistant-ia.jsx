...
import { askAI } from "../api/financeApi";
...
export default function FloatingAssistant({
  ...
  const handleAsk = async (customQuestion) => {
    ...
    try {
      ...
      const fallback = askFinancialAgent(finalQuestion, agentData);
        ...
        <div className="fixed bottom-6 right-6 z-50 flex h-[720px] w-[420px] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
          <div className="flex items-center justify-between bg-blue-700 px-6 py-5 text-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold">Agente Financiero IA</h2>
          ...
          <div className="border-t border-slate-200 bg-white p-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => handleAsk()}
                disabled={loading}
                className="flex items-center justify-center rounded-2xl bg-blue-700 px-5 text-white hover:bg-blue-800 disabled:opacity-60"
              >
                <Send size={20} />
              </button>
            </div>
